...
# 2 create a test based on income category
...
for train_index , text_index in split.split(housing , housing["income_cat"]):
    ...
    strat_test_set = housing.loc[train_index].drop("income_cat" , axis =1)

# we will work on copy
...
# print(f"The root mean squared error for Decision Tree is {dec_rmses}")
# print(ries(random_forest_rmses).describe())